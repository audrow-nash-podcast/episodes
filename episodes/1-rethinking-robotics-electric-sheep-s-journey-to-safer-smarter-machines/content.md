...
> ⚠️ In this episode, I initially did the transcript slug wrong, so the transcript URL is [https://audrow-nash-podcast.github.io/transcripts/1-rethinking-robotics-electric-sheep-s-journey-to-safer-smarter-machines.html](https://audrow-nash-podcast.github.io/transcripts/1-rethinking-robotics-electric-sheep-s-journey-to-safer-smarter-machines.html) (`sheep-s` instead of `sheeps`).
